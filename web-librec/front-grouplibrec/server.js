...
const ratingsUsuariosDir = "/home/asmith/recomendaciones/usuarios"
...
const url = 'mongodb://root:pass@192.168.1.10:27017/?authSource=admin'
const dbName = 'grouplibrec'
    ...
    try {
        ...
        if (n_usuario) {
            ...
            if (req.body.tipo_mensaje === "texto") {
                ...
                let path_imagen = "/home/asmith/web-librec/server-grouplibrec/imagenes-movielens" + "/" + String(req.body.itemId) + ".jpg"
                if (fs.existsSync(path_imagen)) {
                    path_imagen = "http://" + ip + ":8000/imagenes-movielens/" + String(req.body.itemId) + ".jpg"
                }
                else {
...
app.get("/ejecutar-recomendacion-individual", async (req, res) => {
    ...
    try {
        ...
        if (usuario) {
            ...
            const directorioUsuario = "/home/asmith/recomendaciones/usuarios" + "/" + idUsuario
            ...
            fs.copyFileSync("/home/asmith/recomendaciones/dataset/users_data", userData)
            ...
            fs.copyFileSync("/home/asmith/recomendaciones/user.properties", directorioUsuarioProperties)

            // agregar propiedades a las propiedades del grupo
            const semilla = String(2) + "\n"
            const recommenderAlgo = "biasedmf\n"
            const directorioResultado = "/home/asmith/recomendaciones/resultados_usuarios" + "\n"
            ...
            const args = ["-jar", "/home/asmith/recomendaciones/individualLibrec.jar", "-exec", "-conf", idGrupo, directorioUsuarioProperties, idUsuario]
            ...
            grouplibrec.on("close", (code) => {
                if (code === 0) {
                    ...
                    const directorioResultadosSala = "/home/asmith/recomendaciones/resultados_usuarios" + "/" + idGrupo + "/" + idUsuario + "/"
                    let items = []
...
app.get("/ejecutar-recomendacion-grupal", async (req, res) => {
    ...
    try {
        ...
        if (sala) {
            ...
            const directorioGrupo = "/home/asmith/recomendaciones/salas" + "/" + idSala
            ...
            // crear y/o reiniciar dataset del grupo
            fs.copyFileSync("/home/asmith/recomendaciones/dataset/users_data", usersDataGroup)
            ...
            fs.copyFileSync("/home/asmith/recomendaciones/group.properties", directorioProperties)

            // agregar propiedades a las propiedades del grupo
            const semilla = String(2) + "\n"
            const recommenderAlgo = "biasedmf\n"
            const directorioData = usersDataGroup + "\n"
            const directorioResultado = "/home/asmith/recomendaciones/resultados" + "\n"
            ...
            // ejectuar grouplibrec
            const args = ["-jar", "/home/asmith/recomendaciones/grouplibrec.jar", "-exec", "-conf", idSala, directorioProperties, ...groupUsers]
            ...
            grouplibrec.on("close", (code) => {
                if (code === 0) {
                    // devolver items recomendados para el grupo
                    console.log(`exit success: ${code}`)
                    const directorioResultadosSala = "/home/asmith/recomendaciones/resultados" + "/" + idSala + "/"
                    let items = []
                    const recomendaciones = fs.readdirSync(directorioResultadosSala)
                    const directorioUltimaRecomendacion = recomendaciones.sort()[recomendaciones.length - 1]
                    let trecomendaciones = fs.readFileSync(directorioResultadosSala + directorioUltimaRecomendacion + "/recommendations.txt", "utf-8")
...
app.post("/enviar-al-stack", async (req, res) => {
    ...
    let path_imagen = "/home/asmith/web-librec/server-grouplibrec/imagenes-movielens" + "/" + String(idItem) + ".jpg"

    if (fs.existsSync(path_imagen)) {
        path_imagen = "http://" + ip + ":8000/imagenes-movielens/" + String(idItem) + ".jpg"
    }
    else {
        path_imagen = "http://" + ip + ":8000/imagenes-movielens/no_existe.png"
    }
